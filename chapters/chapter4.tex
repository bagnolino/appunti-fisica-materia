...
\begin{remark} Un possibile modo di trattare gli elettroni di valenza è  il
 \textbf{modello a gas di elettroni liberi} in cui gli elettroni di valenza vengono descritti come particelle libere (non interagenti tra loro) confinate all'interno di una buca di potenziale (la "scatola"), che modella macroscopicamente il volume del metallo in cui si trovano.
\end{remark}
...
\subsubsection{Gas di Fermi in un cristallo}
