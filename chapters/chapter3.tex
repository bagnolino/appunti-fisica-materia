...
Se la molecola è monoelementale (omonucleare), per ragioni di simmetria gli integrali relativi ai due nuclei risultano uguali: \( C_1 = C_2 = C \) e \( D_1 = D_2 = D \).
...
\subsection{Spettro rotazionale e vibrazionale}
...
\begin{equation}
    \left. \dv{U_{eff}(R_{AB})}{R_{AB}} \right|_{R_{AB,eq}} = 0
\end{equation}
...
\begin{equation}
    U_{eff}(R_{AB}) \approx \underbrace{U_{eff}(R_{AB,eq})}_{\text{pot. all'equilibrio}} + \underbrace{\frac{1}{2} \left. \dv[2]{U_{eff}}{R_{AB}} \right|_{R_{AB,eq}} (R_{AB} - R_{AB,eq})^2}_{\text{oscillatore armonico quantistico}}
\end{equation}

Introduciamo quindi \( K_{mol} \), definita come la costante elastica della molecola:

\begin{equation}
    K_{mol} := \left. \dv[2]{U_{eff}(R_{AB})}{R_{AB}} \right|_{R_{AB} = R_{AB,eq}}
\end{equation}
...
\begin{solution}
    ...
    In analogia con la fisica classica, la costante elastica della molecola \( K_{mol} \), definita formalmente come la derivata seconda del potenziale efficace valutata all'equilibrio (\( K_{mol} = \left. \dv[2]{U_{eff}}{R_{AB}} \right|_{R_{AB,eq}} \)), è legata alla pulsazione dalla relazione \( \omega_0 = \sqrt{\frac{K_{mol}}{\mu_{HCl}}} \). Invertendo l'espressione otteniamo il primo risultato:
    \begin{equation}
...
\begin{solution}
    ...
    \begin{equation}
        K_{O_2} = \left. \dv[2]{U_{eff}}{R_{AB}} \right|_{R_{AB,eq}}
    \end{equation}
    ...
    \begin{equation}
        \left. \dv[2]{U_{eff}(R_{AB})}{R_{AB}} \right|_{R_{AB,eq}} = 2\alpha^2 U_0
    \end{equation}
